...
class JobStepsOperations(object):
    ...
    def list_by_version(
        ...
        :return: An iterator like instance of JobStep
        :rtype:
        ...
        deserialized = models.JobStepPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.JobStepPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized

    def get_by_version(
            self, resource_group_name, server_name, job_agent_name, job_name, job_version, step_name, custom_headers=None, raw=False, **operation_config):
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('JobStep', response)
    ...
    def get(
            self, resource_group_name, server_name, job_agent_name, job_name, step_name, custom_headers=None, raw=False, **operation_config):
    ...
    def create_or_update(
            self, resource_group_name, server_name, job_agent_name, job_name, step_name, parameters, custom_headers=None, raw=False, **operation_config):
