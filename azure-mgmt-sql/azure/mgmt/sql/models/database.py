...
class Database(TrackedResource):
    ...
    def __init__(self, location, tags=None, sku=None, create_mode=None, collation=None, max_size_bytes=None, sample_name=None, elastic_pool_id=None, source_database_id=None, restore_point_in_time=None, source_database_deletion_date=None, recovery_services_recovery_point_id=None, long_term_retention_backup_resource_id=None, recoverable_database_id=None, restorable_dropped_database_id=None, catalog_collation=None, zone_redundant=None, license_type=None, read_scale=None):
