...
class ElasticPoolPerformanceLevelCapability(Model):
    ...
    :ivar family: The hardware generation.
    :vartype family: str
    ...
    :ivar default_max_size: The default max size for this performance level.
    :vartype default_max_size: ~azure.mgmt.sql.models.MaxSizeCapability
    ...
    _validation = {
        ...
        'default_max_size': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'default_max_size': {'key': 'defaultMaxSize', 'type': 'MaxSizeCapability'},
